...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        local TabBtn = Linux.Instance("TextButton", {
            Parent = TabHolder,
            BackgroundTransparency = 1, -- Fundo transparente por padrão
        ...
        TabBtn.MouseButton1Click:Connect(function()
            for _, tab in pairs(Tabs) do
                ...
                tab.Button.BackgroundTransparency = 1 -- Torna o fundo transparente para abas não selecionadas
            ...
            TabBtn.BackgroundTransparency = 0 -- Mostra o fundo quando a aba é selecionada
            TabBtn.BackgroundColor3 = Linux.Theme.Element -- Define a cor do fundo
            ...
            local targetY = 5 + (tabIndex - 1) * (28 + 3) + 4
            local tweenInfo = TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        ...
        if not CurrentTab then
            TabContent.Visible = true
            TabBtn.BackgroundTransparency = 0 -- Mostra o fundo da primeira aba por padrão
            ...
            CurrentTab = tabIndex
            local initialY = 5 + (tabIndex - 1) * (28 + 3) + 4
